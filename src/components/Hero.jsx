...
{/*Earphones */}
     <div className=' w-[20rem] h-[20rem] border-2 absolute top-[12rem] rounded-full border-zinc-700'>
        <div className=' w-full h-full'>
              <div className='w-[10rem] h-[10rem] rounded-full absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]  border'>
                 {/*image anime*/}
    ...
    {/*Headphones*/}
        ...
        <div className=' w-full h-full'>
              <div className='w-[10rem] h-[10rem] rounded-full absolute -bottom-[32rem] left-[50%] -translate-x-[50%] -translate-y-[50%]  border'>
                 {/*image anime*/}
        <img src="/Headphone.png" alt="" className='ring2 absolute w-[20rem] left-[35%] top-[4rem] translate-x-[50%]' />
    ...
    {/*Speakers*/}
        ...
        <div className=' w-full h-full'>
              <div className='w-[10rem] h-[10rem] rounded-full absolute top-[22rem] left-[50%] -translate-x-[50%] -translate-y-[50%]  border'>
                 {/*image anime*/}
