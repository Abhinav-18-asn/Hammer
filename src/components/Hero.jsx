...
{/*Earphones */}
     <div className='ehs  w-[20rem] h-[20rem] border-3 absolute top-[12rem] rounded-full border-zinc-700'>
    ...
    {/*Headphones*/}
        ...
        <div className=' w-full h-full'>
              <div className='headHero w-[10rem] h-[10rem] rounded-full absolute -bottom-[32rem] left-[50%] -translate-x-[50%] -translate-y-[50%]  border'>
                 {/*image anime*/}
    ...
    {/*Speakers*/}
        ...
        <div className=' w-full h-full'>
              <div className='speakHero w-[10rem] h-[10rem] rounded-full absolute top-[22rem] left-[50%] -translate-x-[50%] -translate-y-[50%] border-zinc-700 border'>
                 {/*image anime*/}
